                            ...
                            <Reveal className="grid justify-items-start gap-3">
                                <div className="flex items-center gap-3">
                                    <Link
                                        ...
                                        onClick={() => trackEvent("usecase_hero_book_call_press")}
                                        className="whitespace-nowrap bg-ink px-[34px] py-[17px] text-base text-paper hover:bg-black cursor-pointer"
                                    >
                                        Book a Call
                                    </Link>
                                    <Link
                        ...
                        {data.steps.map((step, i) => {
                            ...
                            return (
                                <button
                                    ...
                                    onClick={() => {
                                        setTab(i);
                                        trackEvent("usecase_workflow_tab_press");
                                    }}
                                    className={`flex items-center gap-2.5 border px-5 py-[13px] text-[15px] cursor-pointer ${
                                        active
                ...
                <div className="mx-auto max-w-[1180px] px-10 py-[60px]">
                    <Reveal className="grid grid-cols-[1fr_auto] items-center gap-10 bg-[#16303F] px-12 py-11 text-mist">
                        ...
                        <div className="flex flex-shrink-0 items-center gap-3">
                            <Link
                                href="https://calendar.app.google/WbdzvM2oayoF9G6X7"
                                onClick={() => trackEvent("usecase_mid_book_call_press")}
            ...
            <section className="bg-ink text-mist">
                <div className="mx-auto max-w-[1180px] px-10 py-20">
                    ...
                    <Reveal className="grid grid-cols-[1.1fr_1fr] items-start gap-14">
                        ...
                        <Link
                            href="/security"
                            onClick={() => trackEvent("usecase_security_link_press")}
                            className="mt-5 inline-flex items-center gap-2.5 justify-self-start border-b border-accent/70 pb-1 text-base text-mist hover:text-accent cursor-pointer"
                        >
                ...
                <div className="mx-auto max-w-[1180px] px-10 py-[92px] text-center">
                    ...
                    <Reveal className="grid justify-items-center gap-3.5">
                        <div className="flex items-center gap-4">
                            <Link
                                href="https://calendar.app.google/WbdzvM2oayoF9G6X7"
                                onClick={() => trackEvent("usecase_footer_book_call_press")}
                                className="bg-accent px-[34px] py-4 text-base text-ink hover:bg-[#3FBEDD] cursor-pointer"
                            >
                                Book a Call
                            </Link>
                            <Link
