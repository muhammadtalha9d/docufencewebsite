...
const STEPS = [
  { label: "Collaborate & Prep", title: "Collaborate and prep.", body: "Edit text directly on PDFs without breaking margins. Leave inline notes, tag teammates, and black out sensitive PII before files leave your team." },
  { label: "Execute", title: "Execute in the same tab.", body: "Turn approved drafts into legally binding agreements instantly. Collect signatures without envelope caps or third-party redirects." },
  { label: "Secure Hand-Off", title: "Hand off securely.", body: "Share confidential offer letters, financial audits, or vendor contracts via secure links with customized password, view-only, and print restrictions." },
  { label: "Govern", title: "Govern after sending.", body: "Retain total control after sending. Pull back access in one click, auto-expire links, and review complete time-stamped activity logs." },
];
          ...
          {STEPS.map((s, i) => {
            ...
            return (
              <button
                ...
                type="button"
                onClick={() => setStep(i)}
                className="border-t-2 py-[18px] pr-5 text-left"
                style={{
            ...
            {step === 0 && (
              <>
                ...
                <div className="flex items-center gap-2 border-b border-ink/10 px-4 py-2.5">
                  <span className="flex items-center gap-1.5 bg-ink px-3 py-2 text-xs text-paper">
                    <PenLine className="h-[13px] w-[13px] text-accent" />
                    Edit PDF Text
                  </span>
                  <span className="flex items-center gap-1.5 border border-ink/[0.16] px-2.5 py-1.5 text-xs text-ink-faint">
                ...
                <div className="grid flex-1 grid-cols-[minmax(0,1fr)_minmax(150px,214px)] gap-4 bg-[#F1F4F5] px-[22px] py-5">
                  ...
                  >
                    ...
                    <div className="flex gap-2 px-[13px] pb-3.5">
                      <span className="flex-1 border border-ink/[0.16] py-1.5 text-center text-[11px]">Reply</span>
                      <span className="flex-1 bg-accent py-2 text-center text-[11px] text-ink">Resolve</span>
                    </div>
                  </div>
                </div>
              </>
                  ...
                  >
                    ...
                    <div className="px-[18px] pb-4 pt-1">
                      ...
                      <div className="mt-4 flex items-center gap-2.5">
                        <span className="flex-1 bg-ink py-[11px] text-center text-xs text-paper">Create link</span>
                ...
                <div className="grid flex-1 grid-cols-[minmax(0,1fr)_minmax(170px,240px)] gap-4 bg-[#F1F4F5] px-[22px] py-5">
                  <div className="flex flex-col gap-3.5">
                    ...
                    <div className="grid gap-3 border border-ink/[0.12] bg-white px-[18px] py-4">
                      ...
                      <span
                        className="flex items-center justify-center gap-2.5 bg-[#B03030] px-3.5 py-2.5 text-center text-xs text-white"
