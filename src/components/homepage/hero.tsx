                ...
                <Reveal className="grid grid-cols-[1fr_auto] items-end gap-14">
                    ...
                    <div className="flex items-center gap-3.5">
                        ...
                        <Link
                            ...
                            className="whitespace-nowrap border border-ink/20 px-7 py-[15px] text-[15px] text-ink hover:border-ink/45 cursor-pointer"
                            onClick={() => trackEvent("hero_book_a_call_press")}
                        >
                            Book a Call
                        </Link>
                    </div>
