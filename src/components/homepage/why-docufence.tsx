    ...
    return (
        <section className="mx-auto max-w-[1180px] px-10 pb-[100px] pt-[104px]">
            ...
            <Reveal className="grid grid-cols-3 gap-5">
                <div
                    className="border border-ink/[0.12] bg-white"
                    onMouseEnter={() => trackEvent("whydocufence_card_file_workspace_hover")}
                >
                ...
                <div
                    className="border border-ink/[0.12] bg-white"
                    onMouseEnter={() => trackEvent("whydocufence_card_security_hover")}
                >
                    <div className="flex h-[220px] items-center justify-center overflow-hidden bg-ink px-5">
                ...
                <div
                    className="border border-ink/[0.12] bg-white"
                    onMouseEnter={() => trackEvent("whydocufence_card_control_hover")}
                >
                    <div className="flex h-[220px] items-center justify-center overflow-hidden bg-ink px-5">
