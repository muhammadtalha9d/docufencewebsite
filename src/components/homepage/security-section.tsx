        ...
        <section id="security" className="bg-ink text-mist">
            <div className="mx-auto max-w-[1180px] px-10 pb-[108px] pt-[104px]">
                <Reveal className="mb-[60px] flex items-end justify-between gap-10">
                    ...
                    <Link
                        href="/security"
                        className="whitespace-nowrap border-b border-accent/70 pb-1 text-[15px] text-mist hover:text-accent cursor-pointer"
                        onClick={() => trackEvent("security_section_read_full_press")}
                    >
                ...
                <Reveal className="grid grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] items-start gap-14">
                        ...
                        <div className="relative border border-mist/[0.18] bg-white/[0.055] shadow-[0_36px_72px_rgba(0,0,0,0.48)] backdrop-blur-md">
                            ...
                            <div className="px-5 pb-[22px] pt-2">
                                ...
                                <div className="flex items-center justify-between gap-4 pb-0.5 pt-[18px]">
                                    ...
                                    <span
                                        onClick={() => trackEvent("security_card_revoke_press")}
                                        className="flex cursor-pointer items-center gap-2 border border-[#EF4444]/60 px-3.5 py-2 text-[13px] text-[#FF9494] transition-colors hover:border-[#EF4444] hover:bg-[#EF4444] hover:text-white"
                                    >
                    ...
                    <div className="relative z-[1] grid grid-cols-2 gap-3.5">
                        {FEATURES.map(({ icon: Icon, title, body, eventName }) => (
                            <div
                                key={title}
                                onClick={() => trackEvent(eventName)}
                                className="grid cursor-pointer content-start gap-3 border border-mist/[0.12] bg-white/[0.04] px-[22px] pb-6 pt-[22px] transition-colors hover:border-accent/55 hover:bg-white/[0.06]"
                            >
