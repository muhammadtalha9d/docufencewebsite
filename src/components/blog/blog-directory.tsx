          ...
          <div className="flex items-center gap-2.5 border border-ink/20 bg-white px-3.5 py-3">
            ...
            {query && (
              <button
                type="button"
                onClick={() => setQuery("")}
                className="font-mono text-[11px] text-dropdown-sub"
              >
                CLEAR
              </button>
            )}
      ...
      {featured && (
        <section className="mx-auto max-w-[1180px] px-10 pb-16">
          <Reveal
            ...
            className="grid grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)] border border-ink/[0.13] bg-white text-ink shadow-[0_20px_44px_rgba(14,36,51,0.08)] hover:border-accent/60"
          >
        ...
        <div className="grid grid-cols-3 gap-4">
          {filtered.map((post) => (
            <Link
              ...
              className="flex flex-col border border-ink/[0.13] bg-white text-ink hover:border-accent/60"
            >
