...
export const metadata: Metadata = {
  title: "Product",
  description:
    "Every document tool your team needs, in one tab: native PDF editing, unlimited e-signatures, and granular sharing with instant revocation.",
};
  ...
  return (
    <div>
      ...
      <section id="capabilities" className="mx-auto max-w-[1180px] px-10 pb-24">
        <Reveal
          className="grid grid-cols-3 gap-px border-y border-ink/[0.14] bg-ink/[0.14]"
        >
          <a
            href="#editing"
            className="flex items-center gap-4 bg-paper py-[26px] pr-7 text-ink hover:text-link"
          >
          ...
          <a
            href="#signatures"
            className="flex items-center gap-4 bg-paper px-7 py-[26px] text-ink hover:text-link"
          >
          ...
          <a
            href="#sharing"
            className="flex items-center gap-4 bg-paper py-[26px] pl-7 text-ink hover:text-link"
          >
