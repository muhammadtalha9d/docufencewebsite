...
const PILLARS = [
    { href: "#pillar-2", icon: KeyRound, label: "Active access governance", eventName: "security_pillar_governance_press" },
    { href: "#pillar-3", icon: Server, label: "Infrastructure protection", eventName: "security_pillar_infra_press" },
    { href: "#pillar-4", icon: History, label: "Time-stamped audit trails", eventName: "security_pillar_audit_press" },
];
        ...
        <div>
            <section className="mx-auto max-w-[1180px] px-10 pb-[88px] pt-[108px]">
                ...
                <Reveal className="grid grid-cols-[minmax(0,1fr)_auto] items-end gap-14">
                    ...
                    <div className="flex items-center gap-3">
                        <a
                            href="#pillars"
                            onClick={() => trackEvent("security_hero_stance_press")}
                            className="whitespace-nowrap bg-ink px-[30px] py-4 text-base text-paper hover:bg-black cursor-pointer"
                        >
                            Read Our Security Stance
                        </a>
                        <Link
                            href="https://calendar.app.google/WbdzvM2oayoF9G6X7"
                            onClick={() => trackEvent("security_hero_contact_press")}
                            className="whitespace-nowrap border border-ink/[0.22] px-[26px] py-[15px] text-base text-ink hover:border-ink/55 cursor-pointer"
                        >
                            Contact Team
                        </Link>
                    </div>
            ...
            <section id="pillars" className="mx-auto max-w-[1180px] px-10 pb-[92px]">
                <Reveal className="grid grid-cols-3 gap-px border-y border-ink/[0.14] bg-ink/[0.14]">
                    {PILLARS.map(({ href, icon: Icon, label, eventName }) => (
                        <a
                            key={href}
                            href={href}
                            onClick={() => trackEvent(eventName)}
                            className="flex items-center gap-3.5 bg-paper px-6 py-6 text-ink hover:text-link cursor-pointer"
                        >
                        ...
                        <div className="border border-ink/[0.12] bg-white shadow-[0_24px_50px_rgba(14,36,51,0.10)]">
                            ...
                            <div className="px-5 pb-[22px] pt-2">
                                ...
                                <div className="flex items-center justify-between pb-1 pt-[18px]">
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => trackEvent("security_demo_revoke_press")}
                ...
                <div className="mx-auto max-w-[1180px] px-10 py-28 text-center">
                    ...
                    <Reveal className="flex justify-center gap-3.5">
                        <Link
                            ...
                            onClick={() => trackEvent("security_bottom_signup_press")}
                        ...
                        <Link
                            href="https://calendar.app.google/WbdzvM2oayoF9G6X7"
                            onClick={() => trackEvent("security_bottom_book_call_press")}
